...
export const therapies = {
  ...
  terapiaStrumentale: {
    ...
    therapies: {
      ...
      dsc: 'Utilizzo macchinari di ultima generazione per garantire la massima efficacia terapeutica. Ecco nel dettaglio le terapie che offro presso il mio studio di Ercolano.',
      cards: [
        {
          title: 'Laserterapia',
