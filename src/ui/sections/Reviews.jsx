    ...
    <section className="bg-secondary-light flex md:flex-row flex-col py-16 px-[10%]">
      <div className="flex flex-col items-start lg:w-[50%] md:w-[60%] w-full md:pr-16 pr-0 md:gap-16 gap-8 md:pb-0 pb-8">
        <div className="flex flex-col gap-3 md:items-start items-center">
          <h3 className="text-5xl text-shadow-xs md:text-start text-center text-primary-900 font-bold">
        ...
        <div className="hidden md:flex lg:flex-row flex-col gap-3 w-full md:items-start items-center md:pb-0 pb-16">
          <Link
            className="tracking-cta text-lg justify-center bg-cta-100 hover:bg-secondary-light transition-colors border-1 border-cta-100 hover:border-primary-900 duration-300 text-primary-900 p-4 rounded-full shadow-lg flex-row items-end gap-2"
            href="/contatti">
            Prenota una visita
          </Link>
          <Link
            className="group flex flex-row items-center tracking-cta text-lg justify-center bg-secondary-light border-1 border-primary-900 hover:bg-secondary-light-hover transition-colors duration-300 text-primary-900 p-4 rounded-full shadow-lg gap-2"
            href="/contatti">
            +39 3394211017
            ...
            {reviews.map((review, index) => (
              <div
                ...
                <div className="embla__slide__number h-[300px] gap-2">
                  <h3 className="text-3xl font-bold text-ctext">{review.autore}</h3>
      ...
      <div className="flex md:hidden lg:flex-row flex-col gap-3 w-full md:items-start items-center md:pb-0 pb-16 pt-8">
        <Link
          className="tracking-cta text-xl justify-center bg-cta-100 hover:bg-cta-900 transition-colors border-1 border-cta-100 hover:border-cta-900 duration-300 text-primary-900 p-4 rounded-full shadow-lg flex-row items-end gap-2"
          href="/contatti">
          Prenota una visita
        </Link>
        <Link
