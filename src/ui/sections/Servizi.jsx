  ...
  return (
    <section className="pt-80 bg-secondary-light lg:pb-32">
      <div className="flex flex-col items-center w-[80%] m-auto self-center">
        <h3 className="font-roboto uppercase lg:text-5xl text-4xl font-bold tracking-tighter text-shadow-sm text-center pb-1 text-primary-900">
          Come posso aiutarti
        </h3>
        <div className="border-t-5 border-primary-300 h-[1px] w-20"></div>
        <h3 className="lg:text-3xl text-2xl lg:text-start text-center font-display text-ctext/90 pt-3">
          Trattamenti fisioterapici su misura per ogni esigenza del paziente
        </h3>
        <ul className="flex lg:flex-row flex-col pt-12 gap-18 text-xl font-display items-center justify-center pb-16">
